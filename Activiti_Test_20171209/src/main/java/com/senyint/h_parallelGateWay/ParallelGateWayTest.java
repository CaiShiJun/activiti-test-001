package com.senyint.h_parallelGateWay;
...
/**
 * 
* @ClassName: ParallelGateWayTest 
* @Description: 并行网关
* @author Cai ShiJun 
* @date 2017年12月13日 下午2:33:11 
*
 */
	...
	* @date 2017年12月13日 上午8:46:52
	...
	public void deploymentProcessDefinition_inputStream(){
		...
		try{
			...
			String resourceNameBpmn = "parallelGateWay.bpmn";
			InputStream inputStreamBpmn = this.getClass().getResourceAsStream("parallelGateWay.bpmn");
			String resourceNamePng = "parallelGateWay.png";
			...
			Deployment deployment = processEngine.getRepositoryService()	//与流程定义和部署对象相关的Service。RepositoryService：管理流程定义。
												...
												.name("parallelGateWay并行网关")		//添加部署的名称,这里的名称可以自定义。
