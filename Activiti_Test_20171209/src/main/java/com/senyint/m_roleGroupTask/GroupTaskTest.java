package com.senyint.m_roleGroupTask;
	...
	* @date 2017年12月13日 上午8:46:52
	...
	public void deploymentProcessDefinition_inputStream(){
		...
		try{
			...
			//创建角色
			Group group1 = new GroupEntity("总经理");	//public GroupEntity(String id) {this.id = id;}
			identityService.saveGroup(group1);
			Group group2 = new GroupEntity("部门经理");	//public GroupEntity(String id) {this.id = id;}
			identityService.saveGroup(group2);
			
			//创建用户
			User user1 = new UserEntity("乔峰");		//public UserEntity(String id) {this.id = id;}
			identityService.saveUser(user1);
			User user2 = new UserEntity("虚竹");		//public UserEntity(String id) {this.id = id;}
			identityService.saveUser(user2);
			User user3 = new UserEntity("段誉");		//public UserEntity(String id) {this.id = id;}
			identityService.saveUser(user3);
			
			//建立用户和角色的关联关系
			identityService.createMembership(user1.getId(), group2.getId());
			identityService.createMembership("虚竹", "部门经理");
			identityService.createMembership("段誉", "总经理");
