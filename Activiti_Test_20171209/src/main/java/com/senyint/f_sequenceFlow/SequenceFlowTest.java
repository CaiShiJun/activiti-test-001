package com.senyint.f_sequenceFlow;
	...
	* @date 2017年12月13日 上午8:46:52
	...
	public void deploymentProcessDefinition_inputStream(){
		...
		try{
			...
			String resourceNameBpmn = "sequenceFlow.bpmn";
			InputStream inputStreamBpmn = this.getClass().getResourceAsStream("sequenceFlow.bpmn");
			String resourceNamePng = "sequenceFlow.png";
			...
			Deployment deployment = processEngine.getRepositoryService()	//与流程定义和部署对象相关的Service。RepositoryService：管理流程定义。
												...
												.name("SequenceFlow连线")		//添加部署的名称,这里的名称可以自定义。
	...
	* @date 2017年12月10日 上午1:18:15
	...
	public void completeMyPersonalTask(){
		...
		try {
			...
			//完成任务的同时，设置判断所需的流程变量，使用流程变量用来指定完成任务后，下一个连线。流程变量对应bpmn文件中的表达式，如：${message=='不重要'}。
