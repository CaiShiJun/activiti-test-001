...
public class WorkflowServiceImpl implements WorkflowService {
	...
	public void saveStartProcess(WorkflowBean workflowBean) {
		...
		//使用当前登录用户，为流程开始时所需的流程变量 inputUser 初始化值。
		variables.put("inputUser", employee.getName());//表示惟一用户
	...
	/**使用任务ID，获取bpmn文件中当前任务节点中对应的Form key中的连接的值*/
	@Override
	...
	public List<String> findOutComeListByTaskId(String taskId) {
		...
		//3：查询流程定义的实体对象 ProcessDefinitionEntiy对象
	...
	public void saveSubmitTask(WorkflowBean workflowBean) {
		...
		if(pi==null){
			...
			bill.setState(2);
			leaveBillMapper.updateLeaveBill(bill);
		}
